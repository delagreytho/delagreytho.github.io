...
function reproducir(){
	...
	repro.setAttribute('src', '/pf_sfotipy/music/'+songtitle+'.mp3');
	repro.play();
...
function get_album(data){
	...
	this.fuente = '/pf_sfotipy/albums/album-' + this.nombre_album + '.jpg'
...
function my_json(){
	$.ajax({
		...
		dataType : "JSON"
			...
			//for(var i=1; i< (res.disco-this.indicador).length+1; i++){
				//console.log(i);
			//}
	});
